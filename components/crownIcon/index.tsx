    ...
    <div className="animate__bounce">
      ...
      >
        <g>
          <g>
            <path
              d="M60.093,60.583H10.244c-0.999,0-1.844-0.527-1.981-1.518l-4.91-35.291c-0.102-0.73,0.208-1.405,0.804-1.839
          ...
          <g>
            <path
              d="M30.018,54.583H15.486c-0.495,0-0.916-0.154-0.989-0.643l-1.353-8.896c-0.082-0.546,0.294-1.003,0.84-1.085
		   c0.538-0.073,1.055,0.111,1.137,0.658l1.225,7.966h13.671c0.552,0,1,0.447,1,1S30.57,54.583,30.018,54.583z"
            />
          </g>
          <g>
            <path
              d="M13.519,41.178c-0.486,0-0.913-0.355-0.987-0.851l-0.604-4c-0.083-0.546,0.293-1.056,0.839-1.139
          ...
          <g>
            <path
              d="M4.998,19.18c-0.52,0-1.04-0.22-1.41-0.59s-0.59-0.89-0.59-1.41c0-0.53,0.22-1.04,0.59-1.42c0.74-0.74,2.08-0.74,2.83,0
		   c0.37,0.38,0.58,0.89,0.58,1.42c0,0.521-0.21,1.04-0.58,1.41C6.038,18.96,5.528,19.18,4.998,19.18z"
            />
          </g>
          <g>
            <path
              d="M64.998,19.18c-0.52,0-1.04-0.22-1.41-0.59c-0.369-0.37-0.59-0.89-0.59-1.41c0-0.53,0.221-1.04,0.59-1.42
          ...
          <g>
            <path
              d="M34.998,7.18c-0.52,0-1.04-0.22-1.41-0.59s-0.59-0.88-0.59-1.41s0.22-1.05,0.59-1.42c0.74-0.74,2.08-0.74,2.83,0
